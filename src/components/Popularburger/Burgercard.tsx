...
const Burgercard = ({image, price, reviews, title}:Props) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3'>
        {/* image divv */}
        <div className=' w-[200px] mx-auro h-[200px]'>
<Image src ={image}
 alt={title}
  width={200}
   height={200}
...
<div className='flex items-center '>
    <FaStar className =" w-[1rem] h0-[1rem] text-yellow-600 "/>
    <FaStar className =" w-[1rem] h0-[1rem] text-yellow-600 "/>
    <FaStar className =" w-[1rem] h0-[1rem] text-yellow-600 "/>
    <FaStar className =" w-[1rem] h0-[1rem] text-yellow-600 "/>
    <FaStar className =" w-[1rem] h0-[1rem] text-yellow-600 "/>
...
<div  className='text-black opacity-80 ' >({reviews})</div>
      ...
      <p className='mt-[0.5rem] text-black text-opacity-70'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 

      </p>
      <div className='flex mt-[1.4rem] items-center justify-between'>
<h1 className=' text-[25px] font-bold text-red-600'>{price}</h1>
<button className='px-4 py-2 hover:bg-green-700 transition-all duration-200 bg-orange-600 flex
