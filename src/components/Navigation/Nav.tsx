...
<FaBurger className='w-[1.2rem] h-[1.3rem] sm:w-[1.4rem] sm:h-[1.4rem] text-orange-500' />
<h1 className='text-[20px] sm:text-[30px] font-semibold'>The Burger&apos;s corner</h1>
</div>
{/* navlinks */}
...
<button className='px-6 py-2 sm:px-8 sm:py-3 text-[14] sm:text-[16px] bg-blue-950 transition-all 
duration-200 hover:bg-red-600 
